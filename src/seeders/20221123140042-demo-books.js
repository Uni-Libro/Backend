    ...
    await queryInterface.bulkInsert(
      ...
      [
        ...
        },
        {
          ...
          price: 30000,
          category: 'مدیریت، بازاریابی و فروش',
          created_at: new Date(),
          updated_at: new Date(),
        },
        {
          name: 'قلب عشق',
          author_name: 'جان اف. دمارتینی',
        ...
        },
        {
          ...
          price: 25000,
          category: 'دین و عرفان',
          created_at: new Date(),
          updated_at: new Date(),
        },
        {
          name: 'کتاب لبخند‌ بی‌لهجه',
          author_name: 'فیروزه‌ دوما(جزایری)',
          ...
          price: 48000,
          category: 'زندگی‌نامه ، سفرنامه و خاطرات',
          created_at: new Date(),
          updated_at: new Date(),
        },
        {
          name: 'دست پنهان',
          author_name: 'آگاتا کریستی',
        ...
        },
        {
          ...
          author_name: 'جیمزای. رابینسون ، دارون عجم اوغلو',
